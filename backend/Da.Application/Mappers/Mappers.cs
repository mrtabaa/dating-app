// using Da.Application.DTOs;
// using Da.Application.DTOs.Helpers;
// using Da.Shared.Versioning;
//
...
//         new()
//         {
//             Schema = Versioning.AppVersions.Last(),
...
//         };
//
//     public static Follow ConvertAppUserToFollow(string followerId, string followedMemberId) =>
//         new(
//             Versioning.AppVersions.Last(),
//             FollowerId: followerId,
//             FollowedMemberId: followedMemberId
//         );
//
//     public static Message ConvertMessageInDtoToMessage(string content, string userId, string receiverId) =>
//         new(
//             Versioning.AppVersions.Last(),
//             SenderId: userId,
