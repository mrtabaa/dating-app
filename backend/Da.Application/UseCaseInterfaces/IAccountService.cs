namespace Da.Application.UseCaseInterfaces;
...
public interface IAccountService
{
    ...
    public Task<OperationResult<bool>> DeleteUserAsync(string? userEmail, CancellationToken cancellationToken);


    public Task<OperationResult> UpdateLastActive(
