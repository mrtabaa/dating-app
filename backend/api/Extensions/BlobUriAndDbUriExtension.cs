...
public static class BlobUriAndDbUriExtension
{
    ...
    ///     From
    ///     https://dablobstorage.blob.core.windows.net/photos/66377887965c65551fe5bd10/resize-pixel-square/165x165/8f4c9a41-7837-4a00-afc9-b3440d4e55b1_pexels-adrienn-1542085.webp?sv=2023-11-03
    ///     &st=2024-04-05T13%3A54%3A04Z&se=2024-05-06T13%3A54%3A04Z&sr=b&sp=rl&sig
    ///     =BnRgSYl6BTYYoir23Ebc3GCdcyK0888OeiseyqD9QnU%3D
    ///     To
    ///     66377887965c65551fe5bd10/resize-pixel-square/165x165/8f4c9a41-7837-4a00-afc9-b3440d4e55b1_pixels-adrienn-1542085.webp
    /// </summary>
    ...
    )
    {
        ...
        foreach (string part in connectionString.Split(';'))
        {
            ...
            if (keyValue.Length == 2) connectionStringParts[keyValue[0]] = keyValue[1];
        }
